...
import edu.aku.hassannaqvi.tpvics_hh_shrc.databinding.ActivitySectionChCBinding;
...
import edu.aku.hassannaqvi.tpvics_hh_shrc.ui.other.TakePhoto;
import edu.aku.hassannaqvi.tpvics_hh_shrc.utils.DateUtils;
import edu.aku.hassannaqvi.tpvics_hh_shrc.utils.EndSectionActivity;
import edu.aku.hassannaqvi.tpvics_hh_shrc.utils.datecollection.AgeModel;
import edu.aku.hassannaqvi.tpvics_hh_shrc.utils.datecollection.DateRepository;
import kotlin.Pair;

import static edu.aku.hassannaqvi.tpvics_hh_shrc.CONSTANTS.CHILD_ENDING_AGE_ISSUE;
import static edu.aku.hassannaqvi.tpvics_hh_shrc.CONSTANTS.IM01FLAG;
import static edu.aku.hassannaqvi.tpvics_hh_shrc.CONSTANTS.IM02CARDSEEN;
...
import static edu.aku.hassannaqvi.tpvics_hh_shrc.utils.AppUtilsKt.openWarningActivity;
                        ...
                        bi.im02a2.isChecked() ? "2" :
                                bi.im02a3.isChecked() ? "3" :
                                        bi.im02a96.isChecked() ? "96" :
                                                "0");
        f1.put("im02a96x", bi.im02a96x.getText().toString());
