...
import edu.aku.hassannaqvi.tpvics_hh_shrc.databinding.ActivitySectionSs1Binding;
import edu.aku.hassannaqvi.tpvics_hh_shrc.models.FormsContract;

import static edu.aku.hassannaqvi.tpvics_hh_shrc.utils.AppUtilsKt.openEndActivity;
...
public class SectionSS1Activity extends AppCompatActivity {
    ...
    private void SaveDraft() throws JSONException {
        ...
        json.put("ss12", bi.ss12a.isChecked() ? "66"
                ...
                : "0");
        json.put("ss12hh", bi.ss12hh.getText().toString().trim().isEmpty() ? "-1" : bi.ss12hh.getText().toString());
