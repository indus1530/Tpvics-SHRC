package edu.aku.hassannaqvi.tpvics_hh_shrc.core;
...
public class AndroidManager extends Activity implements OnItemClickListener {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        submitQuery.setOnClickListener(new OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                alc2 = dbm.getDataForDatabaseManager(Query10);
        ...
        alc = dbm.getDataForDatabaseManager(Query);
        ...
        select_table.setOnItemSelectedListener(new OnItemSelectedListener() {
            ...
            public void onItemSelected(AdapterView<?> parent,
                ...
                if (pos != 0) {
                    ...
                    ArrayList<Cursor> alc2 = dbm.getDataForDatabaseManager(Query2);
                                                        ...
                                                        .setPositiveButton("yes",
                                                                new DialogInterface.OnClickListener() {
                                                                    ...
                                                                    public void onClick(DialogInterface dialog, int which) {
                                                                        ...
                                                                        ArrayList<Cursor> aldropt = dbm.getDataForDatabaseManager(Query6);
                                                        ...
                                                        .setPositiveButton("yes",
                                                                new DialogInterface.OnClickListener() {
                                                                    ...
                                                                    public void onClick(DialogInterface dialog, int which) {
                                                                        ...
                                                                        ArrayList<Cursor> aldeletet = dbm.getDataForDatabaseManager(Query7);
                                                        ...
                                                        .setPositiveButton("Add",
                                                                new DialogInterface.OnClickListener() {
                                                                    ...
                                                                    public void onClick(DialogInterface dialog, int which) {
                                                                        ...
                                                                        ArrayList<Cursor> altc = dbm.getDataForDatabaseManager(Query4);
    ...
    public void getcolumnnames() {
        ArrayList<Cursor> alc3 = dbm.getDataForDatabaseManager("PRAGMA table_info(" + indexInfo.table_name + ")");
                                    ...
                                    new DialogInterface.OnClickListener() {
                                        ...
                                        public void onClick(DialogInterface dialog, int which) {
                                            ...
                                            if (spinner_value.equalsIgnoreCase("Update this row")) {
                                                ...
                                                //dbm.getData(Query3);
                                                ArrayList<Cursor> aluc = dbm.getDataForDatabaseManager(Query3);
                                            ...
                                            if (spinner_value.equalsIgnoreCase("Delete this row")) {
                                                ...
                                                dbm.getDataForDatabaseManager(Query5);

                                                ArrayList<Cursor> aldc = dbm.getDataForDatabaseManager(Query5);
    ...
    public void refreshTable(int d) {
        ...
        if (d == 0) {
            ...
            ArrayList<Cursor> alc3 = dbm.getDataForDatabaseManager(Query8);
            c3 = alc3.get(0);
            //saving cursor to the static indexinfo class which can be resued by the other functions
